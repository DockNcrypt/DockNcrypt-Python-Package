...
def is_dockncrypt_template(path):
    """
    Checks if a file was originally generated by Dockncrypt by looking
    for the template signature on the first line.
    """
    if not os.path.exists(path):
        return True
    with open(path, "r") as f:
        return f.readline().strip() == "# dockncrypt-template-signature: do-not-edit"
